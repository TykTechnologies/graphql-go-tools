...
func NewDocument() *Document {
	return &Document{
		...
		RootOperationTypeDefinitions: make([]RootOperationTypeDefinition, 0),
		SchemaDefinitions:            make([]SchemaDefinition, 0),
		SchemaExtensions:             make([]SchemaExtension, 0),
		Directives:                   make([]Directive, 0),
		Arguments:                    make([]Argument, 0),
		ObjectTypeDefinitions:        make([]ObjectTypeDefinition, 0),
		ObjectTypeExtensions:         make([]ObjectTypeExtension, 0),
		Types:                        make([]Type, 0),
		FieldDefinitions:             make([]FieldDefinition, 0),
		InputValueDefinitions:        make([]InputValueDefinition, 0),
		InputObjectTypeDefinitions:   make([]InputObjectTypeDefinition, 0),
		InputObjectTypeExtensions:    make([]InputObjectTypeExtension, 0),
		ScalarTypeDefinitions:        make([]ScalarTypeDefinition, 0),
		ScalarTypeExtensions:         make([]ScalarTypeExtension, 0),
		InterfaceTypeDefinitions:     make([]InterfaceTypeDefinition, 0),
		InterfaceTypeExtensions:      make([]InterfaceTypeExtension, 0),
		UnionTypeDefinitions:         make([]UnionTypeDefinition, 0),
		UnionTypeExtensions:          make([]UnionTypeExtension, 0),
		EnumTypeDefinitions:          make([]EnumTypeDefinition, 0),
		EnumTypeExtensions:           make([]EnumTypeExtension, 0),
		EnumValueDefinitions:         make([]EnumValueDefinition, 0),
		DirectiveDefinitions:         make([]DirectiveDefinition, 0),
		VariableValues:               make([]VariableValue, 0),
		StringValues:                 make([]StringValue, 0),
		EnumValues:                   make([]EnumValue, 0),
		IntValues:                    make([]IntValue, 0),
		FloatValues:                  make([]FloatValue, 0),
		Values:                       make([]Value, 0),
		ListValues:                   make([]ListValue, 0),
		ObjectFields:                 make([]ObjectField, 0),
		ObjectValues:                 make([]ObjectValue, 0),
		Selections:                   make([]Selection, 0),
		SelectionSets:                make([]SelectionSet, 0),
		Fields:                       make([]Field, 0),
		InlineFragments:              make([]InlineFragment, 0),
		FragmentSpreads:              make([]FragmentSpread, 0),
		OperationDefinitions:         make([]OperationDefinition, 0),
		VariableDefinitions:          make([]VariableDefinition, 0),
		FragmentDefinitions:          make([]FragmentDefinition, 0),
...
func NewDocumentWithPrealloc() *Document {
	return &Document{
