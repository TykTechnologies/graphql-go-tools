	...
	t.Run("introspection", func(t *testing.T) {
		...
		t.Run("execute type introspection query", runWithoutError(
			ExecutionEngineV2TestCase{
				...
				expectedResponse: `{"data":{"q":{"name":"Query","kind":"OBJECT","fields":[{"name":"droid"},{"name":"search"},{"name":"getBookmarks"}]},"h":{"name":"Human","fields":[{"name":"name"},{"name":"friends"}]}}}`,
			},
		))
		...
		t.Run("execute type introspection query with deprecated fields", runWithoutError(
			ExecutionEngineV2TestCase{
				...
				expectedResponse: `{"data":{"__type":{"name":"Query","kind":"OBJECT","fields":[{"name":"hero"},{"name":"droid"},{"name":"search"},{"name":"getBookmarks"}]}}}`,
			},
		))
